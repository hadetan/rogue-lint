...
const EXPECTED_SELF_HOST_SKIPS: string[] = [
  "computed-property-access:collection-boundary:src/engine/tracking/object-paths/visitor.ts:1876:resolveBoundedHelperCallables()",
  ...
  "helper-call-boundary:array-element:src/engine/tracking/object-paths/visitor.ts:1716:[0]",
  ...
  "helper-call-boundary:object-key:src/engine/tracking/value-liveness.ts:257:entity",
  "helper-call-boundary:object-key:src/engine/tracking/value-liveness.ts:258:position",
  "helper-call-boundary:object-key:src/engine/tracking/value-liveness.ts:259:kind",
  "helper-call-boundary:object-key:src/engine/tracking/value-liveness.ts:260:mayObservePreviousValue",
  "helper-call-boundary:object-key:src/engine/tracking/value-liveness.ts:261:nestedWrite",
  "helper-call-boundary:object-key:src/engine/tracking/value-liveness.ts:262:controlFlowDepth",
  "helper-call-boundary:object-key:src/engine/tracking/value-liveness.ts:263:functionDepth",
  "helper-call-boundary:object-key:src/engine/tracking/value-liveness.ts:264:flowSignature",
  "helper-call-boundary:object-key:src/engine/tracking/value-liveness.ts:274:entity",
  "helper-call-boundary:object-key:src/engine/tracking/value-liveness.ts:275:position",
  "helper-call-boundary:object-key:src/engine/tracking/value-liveness.ts:276:kind",
  "helper-call-boundary:object-key:src/engine/tracking/value-liveness.ts:277:mayObservePreviousValue",
  "helper-call-boundary:object-key:src/engine/tracking/value-liveness.ts:278:nestedWrite",
  "helper-call-boundary:object-key:src/engine/tracking/value-liveness.ts:279:controlFlowDepth",
  "helper-call-boundary:object-key:src/engine/tracking/value-liveness.ts:280:functionDepth",
  "helper-call-boundary:object-key:src/engine/tracking/value-liveness.ts:281:flowSignature",
  ...
  "returned-object:object-key:src/engine/tracking/object-paths/visitor.ts:849:known",
